...
restore_button.place(x=screen_width - 150, y=0)
...
# Main container for product sections
main_container = Frame(account, bg="white")
main_container.place(x=280, y=150, width=screen_width - 300, height=screen_height - 200)

# SECTION: RECOMMENDED
recommended_frame = Frame(main_container, bg="white")
recommended_frame.pack(side=LEFT, padx=10, pady=10, fill="both", expand=True)
...
# SECTION: TOP RATED
top_rated_frame = Frame(main_container, bg="white")
top_rated_frame.pack(side=LEFT, padx=10, pady=10, fill="both", expand=True)
...
# SECTION: LATEST
latest_frame = Frame(main_container, bg="white")
latest_frame.pack(side=LEFT, padx=10, pady=10, fill="both", expand=True)
